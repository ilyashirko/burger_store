...
Для корректного отображения расстояния от ресторанов до адресов клиентов необходимо подключить специальный [сервис Yandex](https://developer.tech.yandex.ru/services/).  

После регистрации сервиса вы получите API KEY, его необходимо поместить в `.env` файл `YANDEX_GEO_API_KEY=casdasde-4asd-4asd-asdd-c4dc574d103e`
